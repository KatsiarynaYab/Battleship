...
class HelpWindow:
    def __init__(self):
        self.help_window = pygame.Surface(config.help_window_size)
        ...
        self.scrollbar.set_position(self.width - config.scrollbar_size[0], 0)
        self.text = ''
    ...
    def update(self, screen):
        self.help_window.fill(config.help_window_color)
        ...
        screen.blit(self.help_window, config.help_window_coordinates, (trunc_world_orig, trunc_world))
